...
const tech32 ="https://cdn.brandfetch.io/idMNEQh7-0/theme/dark/symbol.svg?c=1dxbfHSJFAPEGdCLU4o5B";
...
const tech52 ="https://cdn.brandfetch.io/idREYlLkpD/theme/dark/id-H4pLvmU.svg?c=1dxbfHSJFAPEGdCLU4o5B";
                ...
                <div className="Images flex flex-row items-center justify-center">
                    ...
                    <div className="flex flex-row items-center justify-center absolute">
                        ...
                        <Layers className="z-2 text-white h-7 w-7 sm:h-10 sm:w-10 "></Layers>
                            <div className="stagger-box z-2 items-center justify-center w-9 h-9 rounded-[8px]  md:h-13 md:w-13 md:rounded-xl  backdrop-blur-xl bg-transparent  shadow-lg shadow-white border-[2px] border-t-white border-l-white/50 border-r-white/50 border-b-white/20 hover:scale-115 hover:-mr-10 transition-all duration-500"><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/6/61/HTML5_logo_and_wordmark.svg/960px-HTML5_logo_and_wordmark.svg.png?_=20170517184425" className="px-1 py-1 md:px-2  md:py-2"></img></div>
                            <div className="stagger-box z-2 items-center justify-center w-9 h-9 rounded-[8px]  md:h-13 md:w-13 md:rounded-xl  backdrop-blur-xl bg-transparent  shadow-lg shadow-white border-[2px] border-t-white border-l-white/50 border-r-white/50 border-b-white/20 hover:scale-115 hover:-mr-10 transition-all duration-500"><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/d/d5/CSS3_logo_and_wordmark.svg/960px-CSS3_logo_and_wordmark.svg.png" className="px-2 py-1 md:px-3 md:py-2" ></img></div>
                            <div  className="stagger-box z-2 items-center justify-center  w-9 h-9  rounded-[8px]  md:h-13 md:w-13 md:rounded-xl backdrop-blur-xl bg-transparent  shadow-lg shadow-white border-[2px] border-t-white border-l-white/50 border-r-white/50 border-b-white/20 hover:scale-115 hover:-mr-10 transition-all duration-500"><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/99/Unofficial_JavaScript_logo_2.svg/3840px-Unofficial_JavaScript_logo_2.svg.png" className="px-2 py-1 md:px-2.5 md:py-1.5"></img></div>
